...
export const DATA = {
  ...
  description:
    "AI Engineer who loves building impactful products and creating cool things with code!",
  summary:
    "I'm a software engineer passionate about AI, backend systems and building products that create real impact. I love taking ideas from zero to one — designing, developing, and shipping projects that challenge me and help me grow.",
  avatarUrl: "/me.png",
  skills: [
    "Python",
    "C",
  ...
  contact: {
    email: "gpujachavan@gmail.com",
    // tel: "+123456789",
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/pujachavan10",
        icon: Icons.github,
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/puja-chavan-435795255/",
        icon: Icons.linkedin,
